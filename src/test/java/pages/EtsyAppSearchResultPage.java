...
public class EtsyAppSearchResultPage {

    public EtsyAppSearchResultPage(){
...
@FindBy(xpath = "//*[@class='wt-hide-xs wt-show-md filter-expander']")
...
@FindBy(xpath = "//div[@class='wt-bg-white wt-display-block wt-pb-xs-2 wt-mt-xs-0']//p1[1]//span[@class='currency-value']")
